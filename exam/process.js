...
console.log("platform", process.platform); //운영체제의 플랫폼
console.log("uptime",process.uptime()); //프로세스가 시작된 후 흐른시간
...
// process.enc -> 환경설정 + dotenv(.env 파일에 설정한 부분을 process.env에 대입)